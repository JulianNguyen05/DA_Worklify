      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-500 font-medium mt-1">
            Giám sát toàn diện hệ thống tuyển dụng SmartMatch
          </p>
        </div>
        ...
        <div className="relative z-10 flex gap-3">
          <Link
            to="/admin/reports"
            className="px-5 py-2.5 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 font-semibold rounded-xl text-sm transition-all shadow-sm"
          >
            Xuất báo cáo
          </Link>
          <Link
            to="/admin/jobs-moderation"
            className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl text-sm transition-all shadow-sm flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Thống kê lượng tin đăng & ứng tuyển trong 7 ngày qua
              </p>
            </div>
          </div>
          ...
          <div className="h-72 w-full">
            {isLoading ? (
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart
                  data={stats?.chartData || mockLineData}
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Phân bổ tin tuyển dụng toàn sàn
          </p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-gray-500">
                Cần xác nhận để hiển thị lên hệ thống
              </p>
            </div>
          </div>
          <Link
              ...
              {isLoading ? (
                [...Array(3)].map((_, i) => (
                  <tr key={i} className="animate-pulse">
                    ...
                    <td className="px-6 py-4">
                      <div className="h-8 bg-gray-100 rounded w-20 ml-auto"></div>
                    </td>
                  </tr>
                ))
                  ...
                  <td colSpan="4" className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-400 text-sm">
                        Không còn tin tuyển dụng nào đang chờ duyệt.
                      </p>
                    </div>
                  </td>
                </tr>
...
const StatCard = ({
  ...
  <div
    className={`p-6 rounded-3xl border transition-all duration-300 hover:shadow-md relative overflow-hidden group
  ...
  >
    ...
    <div className="flex justify-between items-start mb-4">
      <div
        className={`w-12 h-12 rounded-xl flex items-center justify-center transition-transform group-hover:scale-110 ${colorClass}`}
      >
        {icon}
      </div>
      {trend && (
